...
const NotaVentaModal = ({ nota, onClose }) => {
  if (!nota) return null;
    ...
    <div className="fixed inset-0 z-[120] flex items-center justify-center bg-black/60 p-4 backdrop-blur-sm">
      ...
      >
        ...
        <div className="mb-6 space-y-1 text-sm">
          <p>
            <span className="font-semibold">Mesero:</span> {nota.mesero || 'No registrado'}
          </p>
          <p>
        ...
        <div className="mb-6 rounded-lg bg-blue-50 px-4 py-3 text-center text-sm font-black text-blue-800 ring-1 ring-blue-100">
          Método de pago: {nota.metodoPago || 'NO REGISTRADO'}
        </div>

        <div className="nota-venta-actions flex flex-col gap-3 sm:flex-row sm:justify-end">
          <button
            type="button"
            onClick={handlePrint}
